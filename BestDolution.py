    ...
    if uploaded_file is not None:
        ...
        if df is not None:
            ...
            if app_mode == "Basic Plots":
                basic_plots(df)
            # Uncomment below for additional plot modes
...
def basic_plots(df):
    ...
    sns.boxplot(data=df)
    plt.title('Boxplot of Algorithm Performance', fontsize=16, fontweight='bold')
    ...
    plt.title('Boxplot of Algorithm Performance Metrics', fontsize=16, fontweight='bold')
    ...
    plt.title("Performance Comparison of Optimization Algorithms", fontsize=14, fontweight='bold')
    ...
    plt.xticks(rotation=45, fontsize=12)
    plt.title("Distribution of Optimization Algorithm Metrics", fontsize=14, fontweight='bold')
    plt.ylabel("Performance Metric", fontsize=12)
    plt.xlabel("Optimization Algorithm", fontsize=12)
    plt.tight_layout()
    st.pyplot(plt)
    ...
    plt.xticks(rotation=45, fontsize=12)
    plt.title("Swarm Plot of Optimization Algorithm Metrics", fontsize=14, fontweight='bold')
    plt.ylabel("Performance Metric", fontsize=12)
    plt.xlabel("Optimization Algorithm", fontsize=12)
    plt.tight_layout()
    st.pyplot(plt)
    ...
    plt.xticks(rotation=45, fontsize=12)
    plt.title("Strip Plot of Optimization Algorithm Metrics", fontsize=14, fontweight='bold')
    plt.ylabel("Performance Metric", fontsize=12)
    plt.xlabel("Optimization Algorithm", fontsize=12)
    plt.tight_layout()
    st.pyplot(plt)
    ...
    plt.title('Boxplot of Optimization Algorithms')
    plt.xticks(rotation=90)
    plt.show()
    ...
    g.add_legend()
    g.fig.suptitle('Facet Grid of Boxplots for Each Algorithm', y=1.05)
    plt.show()
    st.pyplot(plt)
    ...
    plt.title('Boxen Plot of Optimization Algorithms')
    plt.xticks(rotation=90)
    plt.show()
    ...
    plt.title('Boxplot with Swarm Plot of Optimization Algorithms')
    plt.xticks(rotation=90)
    plt.show()
    st.pyplot(plt)
    ...
    plt.title('Horizontal Boxplot of Optimization Algorithms')
    plt.show()
    st.pyplot(plt)
    ...
    plt.title('Horizontal Boxplot with Swarm Overlay')
    plt.show()
...
def advanced_plots(df):
    ...
    fig.suptitle('Boxplots of Optimization Algorithms', fontsize=16)
    ...
    axes[0, 1].set_title('Boxplot with Swarm Plot')
    ...
    axes[1, 1].set_title('Customized Boxplot')
    ...
    plt.title('Boxplot with Mean Points Overlay')
    plt.xticks(rotation=90)
    plt.legend()
    plt.show()
    ...
    plt.title('Boxplot with Emphasized Outliers')
    plt.xticks(rotation=90)
    plt.show()
    st.pyplot(plt)
    ...
    plt.title('Boxplot with Line Plots of Each Algorithm')
    ...
    plt.title('Boxplot with Mean Line Overlay')
    plt.xlabel('Algorithm')
    plt.ylabel('Values')
    plt.legend()
    plt.xticks(rotation=90)
...
def statistical_plots(df) :
    ...
    plt.title('Boxplot with Mean and Median Lines')
    plt.xlabel('Algorithm')
    plt.ylabel('Values')
    ...
    plt.title('Violin Plot with Mean and Median Lines')
    plt.xlabel('Algorithm')
    plt.ylabel('Values')
    plt.legend(loc='upper left', bbox_to_anchor=(1, 1), title='Statistics', fontsize='small')
    plt.xticks(rotation=90)
    ...
    plt.figure(figsize=(12, 6))
    sns.boxplot(data=df_melted, x='Algorithm', y='Value', color='lightgray')
    plt.title('Box Plot with Mean and Median Annotations')
    plt.xlabel('Algorithm')
    plt.ylabel('Values')
    plt.xticks(rotation=90)
    ...
    plt.title('Boxplot with Swarm Overlay and Statistical Annotations')
    plt.xlabel('Algorithm')
    plt.ylabel('Values')
    plt.xticks(rotation=90)
    plt.tight_layout()
